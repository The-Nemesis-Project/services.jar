...
.method private logBootEvents(Landroid/content/Context;)V
    ...
    .line 164
    invoke-direct {p0}, Lcom/android/server/BootReceiver;->logResetReson()V
...
.method private logResetReson()V
    ...
    const-string v3, "/proc/reset_reason"
    ...
    .line 107
    .local v2, "resetString":Ljava/lang/String;
    const/16 v3, 0x400
    ...
    .line 111
    :goto_18
    const-string v3, "Reset_Reason"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "resetString = "
    ...
    invoke-static {v2, v3}, Landroid/os/Debug;->dumpResetReason(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v5, "readTextFile error"
