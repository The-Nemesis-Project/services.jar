...
# instance fields
.field cellProvider:Lcom/samsung/geofence/CellGeofenceProvider;
...
.method private loadProvidersLocked()V
    ...
    .line 488
    :cond_52
    new-instance v2, Lcom/samsung/geofence/CellGeofenceProvider;

    invoke-direct {v2}, Lcom/samsung/geofence/CellGeofenceProvider;-><init>()V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/LocationManagerService;->cellProvider:Lcom/samsung/geofence/CellGeofenceProvider;

    .line 489
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/LocationManagerService;->cellProvider:Lcom/samsung/geofence/CellGeofenceProvider;

    invoke-virtual {v2}, Lcom/samsung/geofence/CellGeofenceProvider;->enable()V
...
.method private removeUpdatesLocked(Lcom/android/server/LocationManagerService$Receiver;)V
    ...
    monitor-exit p1
    :try_end_4d
    .catchall {:try_start_49 .. :try_end_4d} :catchall_71
...
.method private requestLocationUpdatesLocked(Landroid/location/LocationRequest;Lcom/android/server/LocationManagerService$Receiver;IILjava/lang/String;)V
    ...
    const-string v15, "request updating cell info for NETWORK_PROVIDER "
    ...
    invoke-static {v14, v15}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_106
    .catch Ljava/io/IOException; {:try_start_ed .. :try_end_106} :catch_11f
    .catch Landroid/os/RemoteException; {:try_start_ed .. :try_end_106} :catch_139
    ...
    invoke-virtual {v14, v7, v0, v1}, Lcom/android/server/LocationManagerService$LocationWorkerHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method public addTestProvider(Ljava/lang/String;Lcom/android/internal/location/ProviderProperties;)V
    ...
    monitor-exit v5
    :try_end_89
    .catchall {:try_start_6f .. :try_end_89} :catchall_6b
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    monitor-exit v15
    :try_end_329
    .catchall {:try_start_80 .. :try_end_329} :catchall_7d
...
.method public removeTestProvider(Ljava/lang/String;)V
    ...
    monitor-exit v5
    :try_end_68
    .catchall {:try_start_32 .. :try_end_68} :catchall_2f
...
.method public requestGeofence(Landroid/location/LocationRequest;Landroid/location/Geofence;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    :try_end_a9
    .catchall {:try_start_72 .. :try_end_a9} :catchall_c8
...
.method public requestLocationUpdates(Landroid/location/LocationRequest;Landroid/location/ILocationListener;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    monitor-enter v13
    :try_end_44
    .catchall {:try_start_3c .. :try_end_44} :catchall_60
...
.method public systemRunning()V
    ...
    monitor-exit v1
    :try_end_67
    .catchall {:try_start_3 .. :try_end_67} :catchall_10e

    .line 307
    const-string v0, "sec_geofence"

    invoke-static {v0}, Landroid/os/ServiceManager;->getService(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v0

    invoke-static {v0}, Lcom/samsung/geofence/ISecGeofenceManager$Stub;->asInterface(Landroid/os/IBinder;)Lcom/samsung/geofence/ISecGeofenceManager;

    move-result-object v14

    .line 308
    .local v14, "secGeofence":Lcom/samsung/geofence/ISecGeofenceManager;
    if-eqz v14, :cond_84
    ...
    check-cast v12, Lcom/android/server/location/GpsLocationProvider;

    .line 311
    .local v12, "p":Lcom/android/server/location/GpsLocationProvider;
    :try_start_7d
    invoke-virtual {v12}, Lcom/android/server/location/GpsLocationProvider;->getGpsGeofenceProxy()Landroid/location/IGpsGeofenceHardware;

    move-result-object v0

    invoke-interface {v14, v0}, Lcom/samsung/geofence/ISecGeofenceManager;->setGpsGeofenceHardware(Landroid/location/IGpsGeofenceHardware;)V
    :try_end_84
    .catch Landroid/os/RemoteException; {:try_start_7d .. :try_end_84} :catch_111

    .line 318
    .end local v12    # "p":Lcom/android/server/location/GpsLocationProvider;
    :cond_84
    :goto_84
    ...
    .line 319
    .local v13, "sLocation":Lcom/samsung/location/ISLocationManager;
    if-eqz v13, :cond_bb
    ...
    .line 325
    :try_start_a7
    invoke-interface {v13, v11}, Lcom/samsung/location/ISLocationManager;->setFusedLocationHardware(Landroid/hardware/location/IFusedLocationHardware;)V
    :try_end_aa
    .catch Landroid/os/RemoteException; {:try_start_a7 .. :try_end_aa} :catch_11d
    ...
    invoke-interface {v13, v0}, Lcom/samsung/location/ISLocationManager;->setGpsGeofenceHardware(Landroid/location/IGpsGeofenceHardware;)V
    :try_end_bb
    .catch Landroid/os/RemoteException; {:try_start_b4 .. :try_end_bb} :catch_131
    ...
    .end local v13    # "sLocation":Lcom/samsung/location/ISLocationManager;
    .end local v14    # "secGeofence":Lcom/samsung/geofence/ISecGeofenceManager;
    :catchall_10e
    move-exception v0
    ...
    .restart local v12    # "p":Lcom/android/server/location/GpsLocationProvider;
    .restart local v14    # "secGeofence":Lcom/samsung/geofence/ISecGeofenceManager;
    :catch_111
    move-exception v8
    ...
    .restart local v13    # "sLocation":Lcom/samsung/location/ISLocationManager;
    :catch_11d
    move-exception v8
