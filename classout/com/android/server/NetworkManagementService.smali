...
.method private modifyEpdg(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v11}, Lcom/android/server/NativeDaemonConnector$Command;->appendArg(Ljava/lang/Object;)Lcom/android/server/NativeDaemonConnector$Command;
    :try_end_e1
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_94 .. :try_end_e1} :catch_e2
    ...
    :try_end_153
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_e8 .. :try_end_153} :catch_e2
...
.method public addRouteWithMetric(Ljava/lang/String;ILandroid/net/RouteInfo;)Z
    ...
    :try_end_6a
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_65 .. :try_end_6a} :catch_7a
...
.method public clearUidRangeRoute(Ljava/lang/String;II)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/NativeDaemonConnector;->execute(Ljava/lang/String;[Ljava/lang/Object;)Lcom/android/server/NativeDaemonEvent;
    :try_end_34
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_9 .. :try_end_34} :catch_35
...
.method public delSrcRoute([BI)Z
    ...
    :try_end_e
    .catch Ljava/net/UnknownHostException; {:try_start_b .. :try_end_e} :catch_3a
    ...
    invoke-virtual {v6, v0}, Lcom/android/server/NativeDaemonConnector;->execute(Lcom/android/server/NativeDaemonConnector$Command;)Lcom/android/server/NativeDaemonEvent;
    :try_end_38
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_33 .. :try_end_38} :catch_4b
...
.method public readWhiteList()I
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/NativeDaemonConnector;->execute(Ljava/lang/String;[Ljava/lang/Object;)Lcom/android/server/NativeDaemonEvent;
    :try_end_23
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_13 .. :try_end_23} :catch_24
...
.method public replaceSrcRoute(Ljava/lang/String;[B[BI)Z
    ...
    invoke-static {p2}, Ljava/net/InetAddress;->getByAddress([B)Ljava/net/InetAddress;
    :try_end_1c
    .catch Ljava/net/UnknownHostException; {:try_start_19 .. :try_end_1c} :catch_6e
    ...
    invoke-virtual {v0, v7}, Lcom/android/server/NativeDaemonConnector$Command;->appendArg(Ljava/lang/Object;)Lcom/android/server/NativeDaemonConnector$Command;
    :try_end_66
    .catch Ljava/net/UnknownHostException; {:try_start_4b .. :try_end_66} :catch_7e
    ...
    :try_end_6b
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_66 .. :try_end_6b} :catch_87
...
.method public rmcEnable(Z)I
    ...
    :try_end_24
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_b .. :try_end_24} :catch_27
...
.method public rmcSetInterval(I)I
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/NativeDaemonConnector;->execute(Ljava/lang/String;[Ljava/lang/Object;)Lcom/android/server/NativeDaemonEvent;
    :try_end_21
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_a .. :try_end_21} :catch_22
...
.method public rmcSetMac(Ljava/lang/String;)I
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/NativeDaemonConnector;->execute(Ljava/lang/String;[Ljava/lang/Object;)Lcom/android/server/NativeDaemonEvent;
    :try_end_1d
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_a .. :try_end_1d} :catch_1e
...
.method public setAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)V
    ...
    :try_end_108
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_d .. :try_end_108} :catch_10a
    ...
    const-string v1, ""
    :try_end_13d
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_110 .. :try_end_13d} :catch_10a
...
.method public setDnsForwarders([Ljava/lang/String;)V
    ...
    :try_end_38
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_33 .. :try_end_38} :catch_39
...
.method public setMacaddrAcl(I)I
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/NativeDaemonConnector;->execute(Ljava/lang/String;[Ljava/lang/Object;)Lcom/android/server/NativeDaemonEvent;
    :try_end_2a
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_13 .. :try_end_2a} :catch_2b
...
.method public setTxPower(I)I
    ...
    invoke-virtual {v3, v4, v5}, Lcom/android/server/NativeDaemonConnector;->execute(Ljava/lang/String;[Ljava/lang/Object;)Lcom/android/server/NativeDaemonEvent;
    :try_end_2d
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_13 .. :try_end_2d} :catch_30
...
.method public startAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v5, v6}, Lcom/android/server/NativeDaemonConnector;->execute(Ljava/lang/String;[Ljava/lang/Object;)Lcom/android/server/NativeDaemonEvent;
    :try_end_11e
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_b .. :try_end_11e} :catch_120
    ...
    const-string v1, ""
    :try_end_153
    .catch Lcom/android/server/NativeDaemonConnectorException; {:try_start_126 .. :try_end_153} :catch_120
