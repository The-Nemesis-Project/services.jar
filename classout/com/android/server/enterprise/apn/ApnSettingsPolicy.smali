...
.method private isValidApnId(J)Z
    ...
    .catchall {:try_start_1b .. :try_end_8b} :catchall_9c
...
.method public declared-synchronized addUpdateApn(Landroid/app/enterprise/ContextInfo;ZLandroid/app/enterprise/ApnSettings;)J
    ...
    :try_end_4
    .catchall {:try_start_1 .. :try_end_4} :catchall_35d
    ...
    invoke-direct {v0, v1}, Lcom/android/server/enterprise/apn/ApnSettingsPolicy;->validateString(Ljava/lang/String;)Ljava/lang/String;
    :try_end_ae
    .catchall {:try_start_11 .. :try_end_ae} :catchall_35d
    ...
    if-gt v0, v14, :cond_10e

    const/16 v33, -0x2

    move/from16 v0, v33

    if-gt v0, v9, :cond_10e

    const/16 v33, 0x3

    move/from16 v0, v33

    if-ge v0, v9, :cond_19d
    ...
    invoke-static/range {v33 .. v34}, Lcom/android/server/enterprise/log/Log;->w(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_19d
    .catch Ljava/lang/Exception; {:try_start_af .. :try_end_19d} :catch_355
    .catchall {:try_start_af .. :try_end_19d} :catchall_35d
    ...
    if-ge v0, v9, :cond_37d

    const/16 v34, 0x4

    move/from16 v0, v34

    if-le v0, v9, :cond_37d
    ...
    :try_end_350
    .catch Ljava/lang/Exception; {:try_start_19f .. :try_end_350} :catch_39a
    .catchall {:try_start_19f .. :try_end_350} :catchall_35d
    ...
    :try_end_35b
    .catchall {:try_start_358 .. :try_end_35b} :catchall_35d
    ...
    invoke-virtual/range {v32 .. v34}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Integer;)V
    :try_end_398
    .catch Ljava/lang/Exception; {:try_start_360 .. :try_end_398} :catch_39a
    .catchall {:try_start_360 .. :try_end_398} :catchall_35d
    ...
    invoke-virtual {v13}, Ljava/lang/Exception;->printStackTrace()V
    :try_end_39e
    .catchall {:try_start_39b .. :try_end_39e} :catchall_35d
    ...
    invoke-static/range {v33 .. v34}, Lcom/android/server/enterprise/log/Log;->w(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_3e3
    .catch Ljava/lang/Exception; {:try_start_3a2 .. :try_end_3e3} :catch_39a
    .catchall {:try_start_3a2 .. :try_end_3e3} :catchall_35d
...
.method public getApnList(Landroid/app/enterprise/ContextInfo;)Ljava/util/List;
    ...
    :try_end_78
    .catch Ljava/lang/Exception; {:try_start_61 .. :try_end_78} :catch_152
    .catchall {:try_start_61 .. :try_end_78} :catchall_159
    ...
    :try_end_148
    .catch Ljava/lang/Exception; {:try_start_78 .. :try_end_148} :catch_163
    .catchall {:try_start_78 .. :try_end_148} :catchall_160
    ...
    :try_end_156
    .catchall {:try_start_153 .. :try_end_156} :catchall_159
...
.method public getApnSettings(Landroid/app/enterprise/ContextInfo;J)Landroid/app/enterprise/ApnSettings;
    ...
    :try_end_f8
    .catch Ljava/lang/Exception; {:try_start_14 .. :try_end_f8} :catch_ff
    .catchall {:try_start_14 .. :try_end_f8} :catchall_10b
    ...
    :try_end_103
    .catchall {:try_start_100 .. :try_end_103} :catchall_10b
