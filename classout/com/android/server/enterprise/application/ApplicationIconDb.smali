...
.method clearChangedApplicationName(I)Ljava/util/ArrayList;
    ...
    :try_end_b5
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_7 .. :try_end_b5} :catch_bb
    .catchall {:try_start_7 .. :try_end_b5} :catchall_c2
...
.method deleteApplicationIcon(Ljava/lang/String;I)Z
    ...
    invoke-virtual {p0}, Lcom/android/server/enterprise/application/ApplicationIconDb;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_6
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_6} :catch_cc
    .catchall {:try_start_3 .. :try_end_6} :catchall_d3
    ...
    :try_end_8b
    .catch Ljava/lang/Exception; {:try_start_10 .. :try_end_8b} :catch_cc
    .catchall {:try_start_10 .. :try_end_8b} :catchall_d3
    ...
    :try_end_c7
    .catch Ljava/lang/Exception; {:try_start_97 .. :try_end_c7} :catch_cc
    .catchall {:try_start_97 .. :try_end_c7} :catchall_d3
...
.method deleteApplicationName(Ljava/lang/String;I)Z
    ...
    invoke-virtual {p0}, Lcom/android/server/enterprise/application/ApplicationIconDb;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_6
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_3 .. :try_end_6} :catch_ce
    .catchall {:try_start_3 .. :try_end_6} :catchall_d5
    ...
    invoke-virtual {v2, v7, v6, v8, v9}, Landroid/database/sqlite/SQLiteDatabase;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    :try_end_8e
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_10 .. :try_end_8e} :catch_ce
    .catchall {:try_start_10 .. :try_end_8e} :catchall_d5
    ...
    invoke-virtual {v2, v7, v8, v9}, Landroid/database/sqlite/SQLiteDatabase;->delete(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    :try_end_c9
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_9a .. :try_end_c9} :catch_ce
    .catchall {:try_start_9a .. :try_end_c9} :catchall_d5
...
.method getApplicationIcon(Ljava/lang/String;I)[B
    ...
    .catchall {:try_start_10 .. :try_end_50} :catchall_78
...
.method getApplicationIconChangedMap()Ljava/util/HashMap;
    ...
    invoke-virtual {p0}, Lcom/android/server/enterprise/application/ApplicationIconDb;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_a
    .catch Ljava/lang/Exception; {:try_start_7 .. :try_end_a} :catch_6d
    ...
    .catchall {:try_start_13 .. :try_end_6c} :catchall_8d
    ...
    :try_end_8a
    .catchall {:try_start_6e .. :try_end_8a} :catchall_8d
...
.method updateApplicationIcon(Ljava/lang/String;[BI)Z
    ...
    invoke-virtual {p0}, Lcom/android/server/enterprise/application/ApplicationIconDb;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_6
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_6} :catch_b2
    .catchall {:try_start_3 .. :try_end_6} :catchall_b9
    ...
    :try_end_7f
    .catch Ljava/lang/Exception; {:try_start_10 .. :try_end_7f} :catch_b2
    .catchall {:try_start_10 .. :try_end_7f} :catchall_b9
    ...
    :try_end_a9
    .catch Ljava/lang/Exception; {:try_start_8a .. :try_end_a9} :catch_b2
    .catchall {:try_start_8a .. :try_end_a9} :catchall_b9
...
.method updateApplicationName(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    invoke-virtual {p0}, Lcom/android/server/enterprise/application/ApplicationIconDb;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_a
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_7 .. :try_end_a} :catch_c9
    .catchall {:try_start_7 .. :try_end_a} :catchall_d0
    ...
    :try_end_8c
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_14 .. :try_end_8c} :catch_c9
    .catchall {:try_start_14 .. :try_end_8c} :catchall_d0
    ...
    :try_end_c0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_98 .. :try_end_c0} :catch_c9
    .catchall {:try_start_98 .. :try_end_c0} :catchall_d0
    ...
    invoke-virtual {v4}, Landroid/database/sqlite/SQLiteException;->printStackTrace()V
    :try_end_cd
    .catchall {:try_start_ca .. :try_end_cd} :catchall_d0
